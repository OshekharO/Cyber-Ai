...
// Hoist static datasets outside the component function to module scope.
// This prevents re-allocating arrays, objects, and JSX elements on every render
// when users interact with tabs, terminal presets, or FAQ accordions.
...
export function LandingPage({ onGetStarted }: LandingPageProps) {
  ...
  const currentPreset = TERMINAL_PRESETS.find(p => p.id === activePresetId) || TERMINAL_PRESETS[0];
